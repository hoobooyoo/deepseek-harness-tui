...
export class AgentController {
   ...
   */
    ...
    try {
      ...
      if (atFile !== undefined && this.agent !== null) {
        const files = await atFile.search(this.agent, new AbortController().signal);
  ...
  async switchPreset(id) {
    ...
    if (this.agent === null) {
      this.addSystem("No live session to switch presets on.");
      return undefined;
    }
    let picked;
    try {
