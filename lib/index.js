...
export function apply(ctx) {
  ...
  void (async () => {
    ...
    // Boot without creating a session: the TUI opens on its empty home, and
    // the session is materialized lazily by the first action that needs one
    // (a message, a host command, the @ picker). Merely opening and quitting
    // therefore leaves nothing in persistence.
